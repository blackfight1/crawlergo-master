...
func SetInputFile() *cli.PathFlag {
	return &cli.PathFlag{
		Name:        "input-file",
		Aliases:     []string{"i"},
		Usage:       "`Path` of input url file. One URL per line. Such as \"subs.txt\"",
...
func SetOutputMode() *cli.StringFlag {
	return &cli.StringFlag{
		...
		Aliases:     []string{"o"},
		Value:       "console",
		Usage:       "console print or serialize output. Allowed mode:\"console\" ,\"json\", \"txt\" or \"none\".",
...
func SetOutputTXT() *cli.StringFlag {
	return &cli.StringFlag{
		Name:        "output-txt",
		Usage:       "write text output to a txt file. Such as result.txt",
		Destination: &outputTxtPath,
	}
}
